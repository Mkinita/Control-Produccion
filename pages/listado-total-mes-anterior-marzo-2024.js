            ...
            <LayoutIndicadores pagina='Informe-agr'>
                ...
                <div className="bg-gray-200 p-4 rounded-lg shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-semibold">Indicadores Marzo 2024</h2>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">0.97 Trozos / Minuto</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    </div>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">5333 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">5333 m³</td>  
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">2563 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2563 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">2994 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2994 m³</td>   
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">546.1 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">546.1 m³</td>   
                                            </tr>

                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Total</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">3540 m³</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">3540 m³</td>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">3261 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3261 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">2404 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2404 m³</td>   
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">2350 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">2350 m³</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">2407 m³	</td> 
                                                <td className="border border-lime-200 px-1 py-2">112 m</td>
                                                <td className="border border-lime-200 px-1 py-2">321 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2841 m³</td>  
                                            </tr>
                                            <tr>
