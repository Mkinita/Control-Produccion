            ...
            <LayoutIndicadores pagina='Informe-agr'>
                ...
                <div className="bg-gray-200 p-4 rounded-lg shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-semibold">Indicadores Agosto</h2>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">0</td> 
                                                <td className="border border-lime-200 px-1 py-2">0 Trozos / Minuto</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    </div>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">6005 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">6005 m³</td>  
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">2944 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2944 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">3328 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3328 m³</td>   
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">822.1 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">822.1 m³</td>   
                                            </tr>

                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Total</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">4150 m³</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">4150 m³</td>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">3571 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3571 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">2661 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2661 m³</td>   
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">2612 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">2612 m³</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">2808 m³	</td> 
                                                <td className="border border-lime-200 px-1 py-2">72.9 m</td>
                                                <td className="border border-lime-200 px-1 py-2">699. m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3580 m³</td>  
                                            </tr>
                                            <tr>
