...
export default function AdminProducciones() {
    ...
    const fetcher = () => axios('/api/stock-ind').then(datos => datos.data)
    const { data, error, isLoading } = useSWR('/api/stock-ind',fetcher,{refreshInterval: 100} )
    ...
    return(
        <AdminLayout pagina={'Produccion-fecha'}>
            ...
            <h1 className="text-3xl font-black text-center">Stock Terminado Ind</h1>
