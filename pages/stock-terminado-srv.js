...
export default function AdminProducciones() {
    ...
    const fetcher = () => axios('/api/stock-servicio').then(datos => datos.data)
    const { data, error, isLoading } = useSWR('/api/stock-servicio',fetcher,{refreshInterval: 100} )
    ...
    return(
        <AdminLayout pagina={'Produccion-fecha'}>
            ...
            <h1 className="text-3xl font-black text-center">Stock Terminado Srv</h1>
