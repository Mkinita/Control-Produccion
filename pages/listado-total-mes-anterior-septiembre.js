            ...
            <LayoutIndicadores pagina='Informe-agr'>
                ...
                <div className="bg-gray-200 p-4 rounded-lg shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-semibold">Indicadores Septiembre</h2>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">1023</td> 
                                                <td className="border border-lime-200 px-1 py-2">0.99 Trozos / Minuto</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    </div>
                        ...
                        <div className="bg-white p-4 rounded-md shadow">
                            <div className='flex items-center'>
                                ...
                                <div style={{ width: '40%', margin: 'auto' }}>
                                    <CircularProgressbar
                                        styles={buildStyles({
                                            pathColor: 41.1 >= 47 ? '#22c55e' : '#DC2626',
                                            trailColor: '#F5F5F5',
                                            textColor: '#0a0a0a',
                                        })}
                                        value={100}
                                        text={`${formatoNumero(46.3)}%`}
                                    />
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">5029 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">5029 m³</td>  
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">2333 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2333 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">3251 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3251 m³</td>   
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">621.4 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">621.4 m³</td>   
                                            </tr>

                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Total</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">3873 m³</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">3873 m³</td>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">3288 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3288 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">2285 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2285 m³</td>   
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">2219 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">2219 m³</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">1870 m³	</td> 
                                                <td className="border border-lime-200 px-1 py-2">35.6 m</td>
                                                <td className="border border-lime-200 px-1 py-2">722 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2628 m³</td>  
                                            </tr>
                                            <tr>
