            ...
            <table className="table-auto w-full text-center bg-white text-gray-700">
                <tbody>
                    ...
                    <tr className='hover:bg-amber-300 text-sm'>
                        ...
                        <td className="px-1 py-2 w-1/3 text-center border border-amber-400">1031.1 m³</td>
                        <td className="px-1 py-2 w-1/3 text-center border border-amber-400">1075.0 m³</td>    
                    </tr>
                   
                    <tr className='text-sm'>
                        <td className="px-1 py-2 w-1/3 text-center border border-amber-400 font-semibold">Total</td> 
                        <td className="px-1 py-2 w-1/3 text-center border border-amber-400 font-semibold" colSpan="2">1147 m³</td>    
                    </tr>
                </tbody>
            </table>
        </LayoutEmp>
