            ...
            <LayoutIndicadores pagina='Informe-agr'>
                ...
                <div className="bg-gray-200 p-4 rounded-lg shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-semibold">Indicadores Junio 2024</h2>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">2182 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2182 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">2701 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2701 m³</td>   
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">649 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">649 m³</td>   
                                            </tr>

                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Total</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">3350 m³</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">3350 m³</td>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">2102 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2102 m³</td>   
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">2001 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">2001 m³</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">- m³	</td> 
                                                <td className="border border-lime-200 px-1 py-2">2499 m³</td>  
                                            </tr>
                                            <tr>
