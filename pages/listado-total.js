                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">{formatoNumero(totalIngresodzo / 4860)} Trozos / Minuto</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">{formatoNumero(totalVolumensemp /81 * 180)} m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">{formatoNumero(totalIngresoseco  / 312 * 720)} m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                    </div>
