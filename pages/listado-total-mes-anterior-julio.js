            ...
            <LayoutIndicadores pagina='Informe-agr'>
                ...
                <div className="bg-gray-200 p-4 rounded-lg shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-semibold">Indicadores Julio</h2>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">1369</td> 
                                                <td className="border border-lime-200 px-1 py-2">1.20 Trozos / Minuto</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    </div>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">5949 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">5949 m³</td>  
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">2902 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">2902 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">208 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">208 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">3452 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3452 m³</td>   
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">171 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">171 m³</td>   
                                            </tr>

                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Total</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">3623 m³</td>
                                                <td className="border border-lime-200 px-1 py-2 text-center">3623 m³</td>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">3540 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3540 m³</td>   
                                            </tr>
                                        </tbody>
                                        </table>
                                ...
                                <div className="overflow-x-auto py-2 text-xs font-bold">
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Ingreso</td>
                                                <td className="border border-lime-200 px-1 py-2">3475 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3475 m³</td>   
                                            </tr>
                                            <tr>
                                                <td className="border border-lime-200 px-1 py-2">Produccion</td>
                                                <td className="border border-lime-200 px-1 py-2">3400 m³</td> 
                                                <td className="border border-lime-200 px-1 py-2">3400 m³</td>  
                                            </tr>
                                        </tbody>
                                        </table>
                                    ...
                                    <div className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-lime-200 px-1 py-2">73.2 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">439 m³</td>
                                                <td className="border border-lime-200 px-1 py-2">3570 m³</td>  
                                            </tr>
                                            <tr>
