          ...
          <table className="table-auto w-full text-center bg-white uppercase font-bold">
                <tbody>
                        ...
                        <tr className="bg-white">
                            ...
                            <td className="px-2 py-4 w-1/5 text-center">{formatoNumeroEmp(totalVolumens / 9)}</td>
                            <td className="px-2 py-4 w-1/5 text-center">{formatoNumeroDsp(totalIngreso)}</td>
                            <td className="px-2 py-4 w-1/5 text-center">{formatoNumeroDsp(totalIngreso / 9)}</td>
                        </tr>
