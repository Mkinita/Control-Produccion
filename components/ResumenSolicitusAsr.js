...
const ResumenSolicitud = ({paquet}) => {
  ...
  const {handleElimanarSolicitud, handleEditarCantidades,totalasr } = useCombustible()

  return (
    <div className="shadow p-5 mb-3 grid gap-1 grid-cols-1 items-center">
        <div className="flex justify-end">
          <button onClick={() => handleElimanarSolicitud (paquet.id) }>
        ...
        <div className="md:w-4/6">
            ...
            <p className="text-lg font-bold text-center">{totalasr}m³</p>
        </div>
    </div>
  )
}
