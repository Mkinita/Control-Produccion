          ...
          <tbody className="text-center">
            {pedido.map(oc => (
              <tr className="bg-white border-b hover:bg-lime-300 text-sm" key={oc.id}>
                <td className="px-6 py-4 w-1/5 text-center border border-lime-400">{oc.espesor}</td>
                <td className="px-6 py-4 w-1/5 text-center border border-lime-400">{oc.ancho}</td>
                <td className="px-6 py-4 w-1/5 text-center border border-lime-400">{oc.largo}</td>
